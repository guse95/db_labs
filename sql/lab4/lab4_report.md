...
В ходе эксперимента база данных была заполнена тестовыми данными:
...
В лабораторной работе были исследованы следующие типы индексов PostgreSQL:

| Тип индекса      | Назначение                                          |
| ---------------- | --------------------------------------------------- |
| B-Tree           | Поиск по точному совпадению, диапазонам, сортировке |
| Composite B-Tree | Поиск по нескольким столбцам                        |
| GIN + pg_trgm    | Текстовый поиск по подстроке                        |
